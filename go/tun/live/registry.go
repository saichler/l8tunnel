...
func Start(vnic ifs.IVNic) *Registry {
	...
	activateAction(vnic, &ClaimHandler{}, r.Engine, r.dir, common.ClaimService, &tun.TunClaimRequest{}, &tun.TunClaimResponse{})
	activateAction(vnic, &CtlHandler{}, r.Engine, r.dir, common.CtlService, &tun.TunCtlCommand{}, &tun.TunCtlCommand{})
